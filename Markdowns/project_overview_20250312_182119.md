...
*Generated on 2025-03-12 18:21:19 from folder: C:\Users\clint\Pickles*
...
- **Last Modified**: 2025-03-11 22:54:08
- **Size**: 19214 bytes
...
"""
    ...
    # Add check sections with a simpler accordion using data attributes
    ...
    for i, (check_name, check_data) in enumerate(checks.items()):
        ...
        if status == 'completed':
            if isinstance(issues, list) and issues:
                ...
                <button type="button" id="{toggle_id}" class="toggle-btn" data-content-id="{content_id}">View Details</button>
    ...
    # Close HTML and add script with very robust toggle functionality
    html += """
        </div>
    ...
    <script>
    /* Adds event listeners after DOM is fully loaded */
    ...
    /* Alternative initialization that runs immediately */
    (function() {
        // Get all toggle buttons
        var toggleButtons = document.querySelectorAll('.toggle-btn');
