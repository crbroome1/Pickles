...
*Generated on 2025-03-17 18:06:05 from folder: C:\Users\clint\Pickles*
...
- **Last Modified**: 2025-03-17 18:06:00
- **Size**: 24900 bytes
...
Focuses on providing rich auditor-centric features for accessibility remediation.
"""
...
def generate_enhanced_html_report(accessibility_report, output_dir=None):
    """
...
""")
    ...
    <div class="section">
        ...
        <div class="accordion">
            <input type="checkbox" id="accordion-{check_type}-{i}" class="accordion-checkbox">
            <label for="accordion-{check_type}-{i}">View Issues</label>
...
""")
                ...
                if element_info:
                    element_id = f"element-info-{check_type}-{i}"
                    ...
                    <div class="element-info-panel">
                        <input type="checkbox" id="{element_id}-checkbox" class="element-info-checkbox">
                        <label class="element-info-header" for="{element_id}-checkbox">
                ...
                html_parts.append(f"""
                    <div class="verification-section">
                        <label class="verification-checkbox">
                            <input type="checkbox" class="verified-checkbox"> Verified
                        </label>
                        <label class="verification-checkbox">
                            <input type="checkbox" class="fixed-checkbox"> Fixed
                        </label>
                    </div>
                </div>
""")
...
""")
    ...
    <div class="section">
        ...
        <button onclick="exportToCsv()">Export Issues to CSV</button>
    </div>
    ...
    <script>
        // Accordion toggle function for issue sections
        ...
        // Toggle function for element info panels
        function toggleElementInfo(elementId) {{
            var content = document.getElementById(elementId);
            if (content.classList.contains("active")) {{
                content.classList.remove("active");
                content.previousElementSibling.lastElementChild.textContent = "+";
            }} else {{
                content.classList.add("active");
                content.previousElementSibling.lastElementChild.textContent = "-";
            }}
        ...
        function exportToCsv() {{
            ...
            issueItems.forEach(function(item) {{
                ...
                var verified = item.querySelector('.verified-checkbox').checked ? 'Yes' : 'No';
                var fixed = item.querySelector('.fixed-checkbox').checked ? 'Yes' : 'No';
            ...
            // Create CSV content
            var csvContent = "Check Type,Issue,Details,Recommendation,Verified,Fixed\\n";
